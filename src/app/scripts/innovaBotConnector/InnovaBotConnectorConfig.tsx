...
export interface IInnovaBotConnectorConfigState extends ITeamsBaseComponentState {
...
export interface IInnovaBotConnectorConfigProps {
}
...
/**
 * Implementation of the innovaBotConnector Connector connect page
 */
export class InnovaBotConnectorConfig extends TeamsBaseComponent<IInnovaBotConnectorConfigProps, IInnovaBotConnectorConfigState> {
        ...
        if (await this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/innovaBotConnector/config.html?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}`,
