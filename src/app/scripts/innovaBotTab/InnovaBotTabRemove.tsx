...
export interface IInnovaBotTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IInnovaBotTabRemoveProps {

}

/**
 * Implementation of InnovaBot Tab remove page
 */
export class InnovaBotTabRemove  extends TeamsBaseComponent<IInnovaBotTabRemoveProps, IInnovaBotTabRemoveState> {
