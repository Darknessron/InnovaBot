...
3. Give the bot a handle (ex: `innovaBotBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://innovabot.azurewebsites.net/api/messages`
